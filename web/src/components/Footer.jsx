...
export default function Footer() {
  const insta = import.meta.env.VITE_INSTAGRAM_URL || "https://www.instagram.com/c_k.collection__/";
  return (
    <footer className="footer">
      <div className="container" style={{ display: "grid", gap: "2rem", padding: "3rem 0", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))" }}>
        ...
        <div><h4>Infos</h4><p style={{ opacity: .7, fontSize: ".9rem" }}>Paiement à la livraison<br />Livraison 68 wilayas<br />© 2026 C-K-Collection</p></div>
      </div>
    </footer>
  );
}
